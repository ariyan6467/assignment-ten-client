...
const UpdateModal = ({ details, isOpen, onClose }) => {
 ...
 console.log(details);
  ...
  draggable: true
    ...
    const inputStyle = "w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-pink-400 focus:border-pink-400 transition duration-150 ease-in-out";
    const labelStyle = "block text-sm font-medium text-gray-300 mb-1";
    const fieldsetStyles = "grid grid-cols-1 md:grid-cols-2 gap-4";

    return (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-75 flex items-center justify-center p-4 backdrop-blur-sm" onClick={onClose}>
            <div className="bg-gray-800 rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden transform transition-all duration-300 scale-100 animate-fadeIn" onClick={e => e.stopPropagation()}>
                <div className="p-6 md:p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className={fieldsetStyles}>
                            ...
                            <div>
                                <label className={labelStyle} htmlFor="framework">Framework</label>
                                <input
                                    type="text"
                                    id="framework"
                                    name="framework"
                            ...
                            <div>
                                <label className={labelStyle} htmlFor="useCase">Use Case</label>
                                <input
                                    type="text"
                                    id="useCase"
                                    name="useCase"
                            ...
                            <div>
                                <label className={labelStyle} htmlFor="dataset">Dataset</label>
                                <input
                                    type="text"
                                    id="dataset"
                                    name="dataset"
