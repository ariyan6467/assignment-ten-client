...
const Banner = () => {
  ...
  <div className="relative mb-16 md:mb-24  ">
      <div className="absolute -inset-10 bg-gradient-to-r from-indigo-500/15 via-cyan-400/10 to-teal-400/15 blur-3xl -z-10" />
      <div className="relative rounded-[32px] overflow-hidden shadow-2xl border border-[var(--card-border)]/70 h-[520px] md:h-[600px] glass shine">
        <div className="absolute top-6 left-6 flex items-center gap-2 text-xs text-white/70 z-20">
        ...
        <AnimatePresence>
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/35 to-transparent flex flex-col justify-end p-8 md:p-12">
              <motion.h1
                className="text-white text-3xl md:text-5xl font-extrabold mb-2 drop-shadow-xl"
              ...
              <motion.p
                className="text-gray-200 text-base md:text-lg drop-shadow-md max-w-3xl"
                initial={{ y: 50, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
      ...
      {/* Navigation Buttons */}
            <button
          onClick={prevSlide}
          className="absolute left-5 top-1/2 -translate-y-1/2 btn btn-circle btn-soft text-white hover:scale-105"
        >
          ❮
        </button>
        <button
          onClick={nextSlide}
          className="absolute right-5 top-1/2 -translate-y-1/2 btn btn-circle btn-soft text-white hover:scale-105"
        >
          ❯
        </button>
