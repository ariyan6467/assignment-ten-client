...
export default function Navbar() {
    ...
    <>
      {links.map((l) => (
        <li key={l.href}>
          ...
          >
            <span className="text-soft font-serif hover:text-white transition-colors">{l.label}</span>
          </NavLink>
        </li>
      ))}
    </>
  ...
  return (
    <header className="sticky top-0 z-50">
     ...
     <div className="navbar glass border-b border-[var(--border)]/60 backdrop-blur-xl">
        <div className="section-shell flex items-center gap-3 w-full">
          {/* Left: Logo */}
          <div className="navbar-start">
            ...
            >
              <div className="flex justify-center  gap-2">
                <img src="https://i.ibb.co.com/5Wb4wrmG/AI-Inventory-Management-Logo-Design-1.png" alt="" srcset=""
              className="w-12 rounded-2xl"
              />
              <h2 className="text-blue-900 font-serif text-sm">Ai InvenTory <br></br> Management</h2>
              </div>
              </NavLink>
          </div>
       ...
       {/* Middle */}
          ...
          <div className="navbar-end gap-2">
            <button
              id="theme"
              type="button"
              className="btn btn-soft rounded-full shine"
            ...
            {user ? (
              <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow-xl menu menu-sm dropdown-content glass rounded-box w-64">
                  ...
                  <li>
                    <button onClick={signOut} className="btn btn-soft mt-1 w-full">Logout</button>
                  </li>
                </ul>
              </div>
            ) : (
